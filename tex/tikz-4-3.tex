...
\draw[black,thick, ->] (-.2,0) -- (24.5,0) node[right]{$t$};
\draw[black, thick, ->] (0,-8.1) -- (0,8.6) node[above]{$x$};
...
hp4-3-54ans piecewise horizontal periodic
\begin{tikzpicture} [scale=.4]

\draw[cyan] (0,0) grid (12,4);
\draw[black,thick,->] (0,0) --(12.8,0) node[right]{\small$t$};
\draw[black,thick,->] (0,0) --(0,4.8) node[above]{\small$P(t)$};

\foreach \x [evaluate=\x as \xi using int( 4* \x )] in {3,6,9,12} {
 \draw[black] (\x,0.1)--+(0, -.2) node[below]{\small \xi};
};
\foreach \y [evaluate=\y as \yi using int( 100* \y )] in {1,2,3,4} {
 \draw[black] (0.1,\y)--+(-.2,0) node[left]{\small \yi};
};

\draw[red, ultra thick] (0,0)--++(1.5,0)--++(0,3) --++(1.5,0)--++(0,-3)--++(1,0)--++(0,3) --++(1.5,0)--++(0,-3)--++(2,0)--++(0,3) --++(1.5,0)--++(0,-3)--++(1,0)--++(0,3) --++(1.5,0)--++(0,-3)--++(0.5,0);
\end{tikzpicture}
\newline

hp4-3-54wrong1 piecewise linear periodic
\begin{tikzpicture} [scale=.4]
...
\draw[red, ultra thick] (0,2.75)--++(1.5,-2.75)--++(1.5,3)--++(1,-3) --++(1.5,3) --++(2,-3)--++(1.5,3)--++(1,-3) --++(1.5,3)--++(.5,-3/4);
\end{tikzpicture}
\newline

hp4-3-54wrong2 piecewise linear periodic
\begin{tikzpicture} [scale=.4]
...
\draw[red, ultra thick] (0,3)--++(1.5,-3)--++(1.5,3)--++(1,-3) --++(1.5,3) --++(2,-3)--++(1.5,3)--++(1,-3) --++(1.5,3)--++(.5,-3/4);
\end{tikzpicture}
\newline


hp4-3-543wrong3 piecewise horizontal periodic
\begin{tikzpicture} [scale=.4]
...
\draw[red, ultra thick] (0,0)--++(1.5,0)--++(0,3) --++(1.5,0)--++(0,-3)--++(1.5,0)--++(0,3) --++(1.5,0)--++(0,-3)--++(2,0)--++(0,3) --++(1.5,0)--++(0,-3)--++(1,0)--++(0,3) --++(1.5,0)--++(0,-3);
\end{tikzpicture}
\newline
