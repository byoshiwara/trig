...
\draw[magenta!80!black, ultra thick] (O) --  (B)   node[above,midway] {\color{black}$x$};
\draw[magenta!80!black, ultra thick]  (B) -- (C)  node[below right,midway] {\color{black}$6$};
\draw[magenta!80!black, ultra thick] (O) --  (C) ;
\draw[blue!40!white, thick] (1.5,0) arc (180:{180+atan(.75)}:0.5);
\draw[blue!40!white] (1.7,-.1) -- +(-.3,-.15);
\coordinate (O2) at (2.5,0);
\coordinate (B2) at (4.1,0);
\coordinate (C2) at (2.5,-1.2);
\draw[blue, thick] (O2) rectangle +(.2,-.2);
\draw[magenta!80!black, ultra thick] (O2) --  (B2)   node[above,midway] {\color{black}$y$};
\draw[magenta!80!black, ultra thick]  (B2) -- (C2)    node[below right,midway] {\color{black}$5$};
\draw[magenta!80!black, ultra thick] (O2) --  (C2)  ;
\draw[blue!40!white, thick] (3.6,0) arc (180:{180+atan(.75)}:0.5);
\draw[blue!40!white] (3.8,-.1) -- +(-.3, -.15);
\end{tikzpicture}
\newline
